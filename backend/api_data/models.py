...
class RealtimeQuoteModel(Base, TimestampMixin):
    ...
    # 五档盘口数据
    buy1_price: Mapped[float] = mapped_column(Float, nullable=True, comment="买一价")
    buy1_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="买一量")
    buy2_price: Mapped[float] = mapped_column(Float, nullable=True, comment="买二价")
    buy2_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="买二量")
    buy3_price: Mapped[float] = mapped_column(Float, nullable=True, comment="买三价")
    buy3_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="买三量")
    buy4_price: Mapped[float] = mapped_column(Float, nullable=True, comment="买四价")
    buy4_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="买四量")
    buy5_price: Mapped[float] = mapped_column(Float, nullable=True, comment="买五价")
    buy5_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="买五量")
    sell1_price: Mapped[float] = mapped_column(Float, nullable=True, comment="卖一价")
    sell1_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="卖一量")
    sell2_price: Mapped[float] = mapped_column(Float, nullable=True, comment="卖二价")
    sell2_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="卖二量")
    sell3_price: Mapped[float] = mapped_column(Float, nullable=True, comment="卖三价")
    sell3_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="卖三量")
    sell4_price: Mapped[float] = mapped_column(Float, nullable=True, comment="卖四价")
    sell4_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="卖四量")
    sell5_price: Mapped[float] = mapped_column(Float, nullable=True, comment="卖五价")
    sell5_volume: Mapped[float] = mapped_column(Float, nullable=True, comment="卖五量")
